...
#打卡内容，dkdz,打卡地点，dkly,打卡地点来源，dkd,自己填写的地址，jzdValue,区号，，jzdSheng.dm,省代码，jzdShi.dm市代码，jzdXian.dm,县代码，jzdDz,家庭地址，jzdDz2,家庭地址2，lxdh,手机号，sfzx1,在校状态，fbrq,fxrq打卡日期，operationType,操作类型
data = {'dkdz':'这里填写打卡密码','jzdValue':'省级代码%2C市级代码%2C县级代码','jzdSheng.dm':'省级代码','jzdShi.dm':'市级代码','jzdXian.dm':'县级代码','jzdDz':'这里填家庭地址','jzdDz2':'这里填家庭地址','lxdh':'填写手机号','sfzx':'0','sfzx1':'不在校','twM.dm':'01','tw1':'[35.0~37.2]正常','yczk.dm':'01','yczk1':'无症状','fbrq':'todaytimes','jzInd':'0','jzYy':'','zdjg':'','fxrq':'todaytimes','brStzk.dm':'01','brStzk1':'身体健康、无异常','brJccry.dm':'01','brJccry1':'未接触传染源','jrStzk.dm':'01','jrStzk1':'身体健康、无异常','jrJccry.dm':'01','jrJccry1':'未接触传染源','jkm':'','jkm1':'','xcm':'','xcm1':'','xgym':'','xgym1':'','hsjc':'','hsjc1':'','bz':'这里填写备注，如果没有则删除','operationType':'Create','dm':''}
